...
На карточке: дата и день недели, погода сейчас + «днём / ночью», прогноз на 2–5 дней (`д` — днём, `н` — ночью), восход и закат, фаза Луны с процентом освещённости, город и время обновления. Ровно 2 цвета — идеально для e-ink.

**🌐 Языки интерфейса:** Русский · English · 中文 · Español · Deutsch · Tiếng Việt — определяются автоматически, RU/EN переключаются кнопками в шапке.
...
Весь сайт — один `index.html`, и у него есть карта. Смотри **[DEVELOPMENT.md](DEVELOPMENT.md)**: структура кода, шпаргалка «где что править», известные грабли и процесс релиза. Идея проекта и roadmap показаны на самом сайте (блоки 💡 и 🛣 в боковой панели).
