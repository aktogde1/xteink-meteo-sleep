...
На карточке: дата и день недели, погода сейчас (иконка + описание), почасовой прогноз до конца сегодняшнего дня (температура, иконка и вероятность осадков — что будет завтра, узнаем завтра), «днём / ночью», восход и закат, фаза Луны строчкой (название + процент освещённости), город и время обновления. Переключатель светлой/тёмной карточки. Ровно 2 цвета — идеально для e-ink.
